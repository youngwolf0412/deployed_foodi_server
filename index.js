...
mongoose
  .connect(
    `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@foodi-client.3xdxmex.mongodb.net/foodi-client?retryWrites=true&w=majority`
  )
  .then(console.log("Mongodb connected"))
  .catch((error) => console.log("Error connecting to mngoDB", error));
